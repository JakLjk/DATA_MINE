class Links:
    ...
    MAIN_LINK  = "https://domain.com/houses/page=1"
    ...
    PARSED_MAIN_LINK = "https://domain.com/houses/page={}"
...
class ScrapeConfig:
    ...
    # mining script won't iterate over old/dead links which are no longer avilable
